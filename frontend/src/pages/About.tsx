...
export default function About() {
  ...
  const faqs = [
    { q: 'Как работает платформа?', a: 'LawyerAI использует передовые модели искусственного интеллекта, специально обученные на законодательстве Узбекистана. Загрузите документ или задайте вопрос — и получите мгновенный анализ с ссылками на нормативные акты.' },
      ...
      <nav className="landing-nav">
        <div className="landing-container nav-container">
          <div className="nav-logo" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <Scale className="w-6 h-6 text-primary" /> Lawyer<span className="text-primary">AI</span>
          </div>
        ...
        <div className="landing-container">
          <div className="cta-content">
            ...
            <p className="cta-subtitle">
              Запросите демонстрацию платформы и узнайте, как LawyerAI может помочь вашему бизнесу.
            </p>
          ...
          <div className="footer-grid">
            <div className="footer-brand">
              <div className="landing-logo">
                <Scale className="w-8 h-8 text-white" /> Lawyer<span className="text-primary">AI</span>
              </div>
              <p>
